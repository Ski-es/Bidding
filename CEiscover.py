...
st. write('---------------------------------------')
st.title('Kindly Input the Needed Information')
with st.form(key = "FORM 1"):
    name = st. text_input(label = " Enter  Your  Name")
    number = st. text_input("Enter Your Age")
    submit = st.form_submit_button(label= "Submit this Form")
    print('You submitted the form required. You may proceed.')



st.write("-------------------------------------------")
st.title("INTERESTING FACTS IN THE FIELD OF CIVIL ENGINEERING")
tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8, tab9, tab10, tab11, tab12, tab13, tab14, tab15 = st.tabs(["FACT 1", "FACT 2", "FACT 3", "FACT 4", "FACT 5", "FACT 6", "FACT 7", "FACT 8", "FACT 9", "FACT 10", "FACT 11", "FACT 12", "FACT 13", "FACT 14", "FACT 15"])
...
with tab1:
    ...
    img = Image.open('ENGINEERING vs. ARCHITECTURE.png')
    st.image(img)


with tab2:
    st.subheader("FACT 2")
    st. write ("Civil engineers – they’ve gone green: Civil engineers do more than design and construct lighthouses. These professionals often assist in planning ways to reduce future pollution and help clean up existing pollution.")
    st. write ("Civil engineers work on complex projects, and they can achieve job satisfaction in seeing the project reach completion. Civil engineering is one of the oldest engineering disciplines because it deals with constructed environment including planning, designing, and overseeing construction and maintenance of building structures, and facilities, such as roads, railroads, airports, bridges, harbors, channels, dams, irrigation projects, pipelines, power plants, and water and sewage systems. ")
    from PIL import Image
    CE = Image.open('CE WORKS.jpg')
    st.image(CE)
...
with tab4:
    ...
    EMK = Image.open('Engr.Marcial Kasilag.jpg')
    st.image(EMK)
...
with tab6:
    ...
    img = Image.open('CONSTRUCTION SITE.jpg')
    st.image(img)
...
with tab7:
    ...
    img = Image.open('MATERIAL ENGINEER.jpg')
    st.image(img)
...
with tab8:
    ...
    img = Image.open('EARTHQUAKE ENGINEER.jpg')
    st.image(img)
...
with tab10:
    ...
    img = Image.open('Nora Stanton Blatch.jpg')
    st.image(img)
...
with tab14:
    ...
    img = Image.open('John_Smeaton.jpg')
    st.image(img)
...
with tab1:
    ...
    img = Image.open("mactan-cebu.jpg")
    st.image(img)
...
with tab2:
    ...
    from PIL import Image
    img = Image.open('national arts center.jpg')
    st.image(img)
...
with tab8:
    ...
    img = Image.open('st. augustine chuch.jpg')
    st.image(img)
...
with tab9:
    ...
    img = Image.open('mind museum.jpg')
    st.image(img)
...
with tab11:
    ...
    with st.expander(' Architecture and Design '):
        ...
        st.write(' The facade of the National Theater is dominated by a two-storey travertine block and deep concave'
                 ' cantilevers on three sides. It is clad by concrete textured by crushed seashells.')

    from PIL import Image

    img = Image.open('ccp1.jpg')
    st.image(img)

with tab12:
    st.subheader(" CALLE CRISOLOGO ")
    st.write(' Calle Crisologo owes its name to the illustrious Ilocano poet, writer, and playwright Governor Marcelino'
    ...
    st.write(' It took 10 years for Vigan to be named a World Heritage Site since it was submitted for consideration'
...
with tab13:
    ...
    with st.expander(" Architecture and Design "):
        st.write(
            ...
            'appearance.')
        st.write(' The structure of The Ruins is of Italianate architecture with neo-Romanesque columns, having a very '
...
with tab14:
    ...
    st.write(' Intramuros (Latin for "inside the walls") is the 0.67-square-kilometer (0.26 sq mi) historic walled area'
    ...
    with st.expander(" Architecture and Design "):
        st.write(' Intramuros, or the ‘Walled City’, is one of the oldest districts of Manila, built on the south bank'
        ...
        st.write(' Intramuros fortification was designed as a trapezoidal layout, located on a wedge formed by the sea'
    ...
    img = Image.open('Intramuros.jpg')
    st.image(img)

with tab15:
    st.subheader(" MANILA HOTEL")
    st.write(' Manila Hotel is a beautiful 5-star hotel located in Manila just 701 m from iconic Intramuros and 901 m '
    ...
    with st.expander(" Architecture and Design "):
        ...
        st.write(' Measuring 125 feet (38 m) long by 25 feet (7.6 m) wide, the lobby is lined with white Doric columns.'
    ...
    img = Image.open('Manila.png')
    st.image(img)

with tab16:
    st.subheader(" SAN JUANICO BRIDGE ")
    st.write(' The San Juanico Bridge (Filipino: Tulay ng San Juanico; Waray: Tulay han San Juanico) is part of the '
    ...
    st.write(' Marcos built the bridge as a personal gift to his wife Imelda using public funds siphoned through the'
    ...
    with st.expander(' Architecture and Design '):
        st.write(' San Juanico Bridge’s is made of a steel girder viaduct built on reinforced concrete piers, and its '
...
with tab17:
    ...
    with st.expander(' Architecture and Design '):
        st.write(' The Philippine Heart Center is seated on a 2.7 hectare lot at the corner of East Avenue and Matalino'
...
with tab18:
    ...
    with st.expander(' Architecture and Design '):
        st.write(' The bridge spans 8.9 kilometers (5.5 mi) and is the longest and tallest bridge in the Philippines,'
        ...
        st.write(' The 390-meter-long (1,280 ft) main span of the CCLEX is cable-stayed and are supported by 145-meter-'
...
with tab19:
    ...
    st.write(' The National Kidney and Transplant Institute is a tertiary referral hospital located in Central, Quezon'
    ...
    img = Image.open('NKTI.jpg')
    st.image(img)
with tab20:
    st.subheader(" METRO MANILA SKYWAY ")
    st.write(' The Metro Manila Skyway, officially the Metro Manila Skyway System (MMSS) or simply the Skyway, is an'
...
with st.container():
    image_column, text_column = st.columns((1,2))
    from PIL import Image
    imgg = Image.open('NEWS3.png')
    st.image(imgg)

with text_column:
    st.subheader("Tanod sa Cebu, cum laude sa kursong civil engineering")
    st.write('"Lodi" kung ituring ng kaniyang mga kaklase at guro ang tanod ng Barangay Kalubihan na si Janryll Tan na nagtapos na cum laude sa kursong civil engineering sa isang kolehiyo sa Cebu.')
    st. markdown("[Watch the Video >](https://youtu.be/Jeda0NqVdPM)")

with st.container():
    image_column, text_column = st.columns((1,2))
    from PIL import Image
    imgg = Image.open('NEWS4.png')
    st.image(imgg)

with text_column:
    st.subheader("DAY IN THE LIFE OF A CIVIL ENGINEER IN US (PINOY)")
    st.write("In this video, I will share my typical day in the life as a Construction Civil Engineer (Office Edition) in America. By the way, I'm a Filipino Engineering Graduate who migrated in US last 2015.")
    st. markdown("[Watch the Video >](https://youtu.be/T_eVkOoLFAk)")

with st.container():
    image_column, text_column = st.columns((1,2))
    from PIL import Image
    imgg = Image.open('NEWS5.png')
    st.image(imgg)

with text_column:
    st.subheader("A Day in the Life of a Civil Engineer | OFFICE Edition")
    st.write("After a long period of working from home, I'm excited to document a day in my life as a City Traffic Engineer in the office. Traffic engineering is a sub-discipline of civil engineering")
    st. markdown("[Watch the Video >](https://youtu.be/qCZQj9TWCw4)")

with st.container():
    image_column, text_column = st.columns((1,2))
    from PIL import Image
    imgg = Image.open('NEWS6.png')
    st.image(imgg)

with text_column:
    st.subheader("What Is Civil Engineering? (Is A Civil Engineering Degree Worth It?)")
    st.write("These videos are for entertainment purposes only and they are just Shane's opinion based off of his own life experience and the research that he's done. ")
